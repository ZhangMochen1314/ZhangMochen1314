...
from .results import CCAResults

def cca(data: pd.DataFrame, x_features: list[str], y_features: list[str], n_components: int = 2) -> CCAResults:
    ...
    return CCAResults(n_components=n_components, x_weights=x_weights, y_weights=y_weights)
