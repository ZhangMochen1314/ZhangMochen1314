...
description: Use this skill when the user asks to collect, download, or query empirical research data from external sources (CSMAR, Wind, National Bureau of Statistics) or local datasets (city/province/county panel data, firm control variables, etc.). This skill can fetch macro-economic, financial, and firm-level data, perform format conversions (CSV/DTA/XLSX), and extract specific variables and samples based on user requirements.
dependency:
  python:
    - pandas>=1.5.0
    - requests>=2.28.0
